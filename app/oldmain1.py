...
# post's structure: title str, content str, published bool, rating Optional[int]
...
def get_post(id: int, res: Response): #id: str should not be written here, cuz validating id as int will be difficult
    #previous code
    # post = find_post(id)
...
def update_post(id: int, post: Post):
    ...
    if cursor.rowcount > 1:
        ...
        conn.rollback()  # Destroys the uncommitted changes completely
